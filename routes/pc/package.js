...
function index_b(req, res, next) {
    res.render('pc/packageb', { title: '桃微婚纱摄影--B套系',layout:'layout_pc' });
}
function index_c(req, res, next) {
    res.render('pc/packagec', { title: '桃微婚纱摄影--C套系',layout:'layout_pc' });
}
function index_d(req, res, next) {
    res.render('pc/packaged', { title: '桃微婚纱摄影--D套系',layout:'layout_pc' });
}
function index_e(req, res, next) {
    res.render('pc/packagee', { title: '桃微婚纱摄影--E套系',layout:'layout_pc' });
}
